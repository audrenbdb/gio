...
// A Gio program that demonstrates Gio widgets. See https://github.com/audrenbdb/gio for more information.
...
import (
	...
	"github.com/audrenbdb/gio/app"
	"github.com/audrenbdb/gio/f32"
	"github.com/audrenbdb/gio/font/gofont"
	"github.com/audrenbdb/gio/gpu/headless"
...
func main() {
	...
	go func() {
		w := app.NewWindow(app.Size(unit.Dp(800), unit.Dp(700)), app.Centered(true))
